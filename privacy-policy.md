...
- Gameplay and app usage events (analytics)
- Crash diagnostics and device diagnostics (crash reporting)
- Advertising-related identifiers and ad interaction signals (for ad delivery and measurement)
- Locally stored game data (for example, settings and progress) stored on your device
...
## 3. SDKs and Third Parties

The app uses third-party SDKs, including Google AdMob / Google Mobile Ads and Firebase services (such as Analytics and Crashlytics). These SDKs may process data under their own privacy terms.
...
Locally stored app data remains on your device until you clear app data or uninstall the app.

Analytics/crash/advertising data retention is controlled by the corresponding third-party service providers.
...
We rely on platform and third-party security controls, including encrypted transport where applicable.
