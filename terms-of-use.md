...
We grant you a personal, non-exclusive, non-transferable, revocable license to use the App for lawful personal use.

## 2. Acceptable Use

You agree not to:

- misuse, reverse engineer, or disrupt the App
- use the App for unlawful activity
- interfere with app services, ad integrations, or analytics systems

## 3. Third-Party Services

The App may include third-party services and SDKs (for example ads and analytics). Their own terms and privacy policies may apply.
